import ML100K_KMeansClustering#SidExtractMatrix3 doesn't sort clusters according to MSR
import ML100KExp1 #Fahad1 contains MSR sorted Bics in 6x6 GridPos, Fahad2 contains non-MSR sortde Bics of 8x8 Grid in GridPos
...
#d =  pd.read_csv("F:/Thesis Supervised/Year 2023/NZD/Python NZD1/Amna RL2/ML100K_Testset.csv", sep=',', engine='python')
d =  pd.read_csv("F:/Thesis Supervised/Year 2023/NZD/Python NZD1/Amna RL2/Movielens100k.csv", sep=',', engine='python')

data = np.array(d)
#print(data.shape[0])
firscol=[]
firscol=list(data[:,4]) # Extract first column of the data
fit={}
users= set(firscol)
...
filepath = "F:/Thesis Supervised/Year 2023/NZD/Python NZD1/Amna RL/movielens1.csv";
Dictobj_Users,Dictobj_Products,df_cluster =ML100K_KMeansClustering.KMeans_Clusters(filepath)
notPred=0;
StartStates=[]
dicty={}
